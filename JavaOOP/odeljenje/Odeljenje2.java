...
public class Odeljenje2 {
    private String oznaka;
    private ArrayList<Ucenik> dnevnik;

    public Odeljenje2(String oznaka, ArrayList<Ucenik> dnevnik) {
        this.oznaka = oznaka;
        this.dnevnik = dnevnik;
    }

    public Odeljenje2(String oznaka) {
        this.oznaka = oznaka;
    ...
    public void prosecnaOcenaOdeljenja(Odeljenje2 x){
    ...
    public String velicinaOdeljenja(){
        String ispis;
        if(getDnevnik().size()>25){
            ispis ="Veliko odeljenje";
        }
        else if(getDnevnik().size()<=25 && getDnevnik().size()>= 15){
            ispis ="Srednje odeljenje";
        }
        else{
            ispis ="Malo odeljenje";
        }
        return ispis;
    }
